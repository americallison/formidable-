    ...
    return (
        ...
        <div className="container mb-3 mt-4">
            ...
            <p className='container'>Create forms easily to collect meaningful data and scale your business and school.</p>
                <Link to="/formcreation"><button className='p-2 m-2 btn bg-success text-white rounded'>Create Form</button></Link>
                <Link to="/pricing"><button className='p-2 btn m-2 rounded bg-dark text-white rounded'>Pricing</button></Link>
